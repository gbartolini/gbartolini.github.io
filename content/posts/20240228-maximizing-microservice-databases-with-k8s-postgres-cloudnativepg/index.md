...
[level 5 Kubernetes Operator](https://cloudnative-pg.io/docs/current/operator_capability_levels/),
...
[*instance manager*](https://cloudnative-pg.io/docs/current/instance_manager/)
...
The decision to bypass statefulsets and [directly manage PVCs](https://cloudnative-pg.io/docs/current/controller/)
...
[Prometheus exporters](https://cloudnative-pg.io/docs/current/monitoring/),
as well as [direct log stream in JSON format to stdout](https://cloudnative-pg.io/docs/current/logging/).

Key features encompass [continuous backup](https://cloudnative-pg.io/docs/current/backup/)
and [point-in-time recovery](https://cloudnative-pg.io/docs/current/recovery/),
[rolling updates](https://cloudnative-pg.io/docs/current/rolling_update/),
[fencing](https://cloudnative-pg.io/docs/current/fencing/),
[hibernation](https://cloudnative-pg.io/docs/current/declarative_hibernation/),
along with the ability to replicate across Kubernetes clusters, also known as [replica clusters](https://cloudnative-pg.io/docs/current/replica_cluster/).

CloudNativePG features a powerful [`kubectl` plugin known as `cnpg`](https://cloudnative-pg.io/docs/current/kubectl-plugin/),
...
[quickstart](https://cloudnative-pg.io/docs/current/quickstart/).

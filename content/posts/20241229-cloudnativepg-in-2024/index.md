...
streamline our [support policy](https://cloudnative-pg.io/docs/current/supported_releases/#support-policy).
...
process has allowed us to provide our user base with [preview versions](https://cloudnative-pg.io/docs/current/preview_version/)

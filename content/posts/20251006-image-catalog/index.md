...
[**Image Catalogs**](https://cloudnative-pg.io/docs/current/image_catalog/)
...
For a deeper dive, check out the official documentation on [image catalogs](https://cloudnative-pg.io/docs/current/image_catalog/)
and [spread upgrades](https://cloudnative-pg.io/docs/current/installation_upgrade/#spread-upgrades).

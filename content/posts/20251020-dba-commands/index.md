...
[RBAC (Role-Based Access Control)](https://cloudnative-pg.io/docs/current/security/#role-based-access-control-rbac)
...
and, more importantly, with the [CloudNativePG plugin](https://cloudnative-pg.io/docs/current/kubectl-plugin/).
...
[official documentation](https://cloudnative-pg.io/docs/current/labels_annotations/)).

...
It ultimately led to a [new default behaviour](https://cloudnative-pg.io/docs/current/instance_manager/#primary-isolation)
...
- **Foundation for quorum-based failover:** Enables the experimental
  [quorum-based failover](https://cloudnative-pg.io/docs/current/failover/#failover-quorum-quorum-based-failover)

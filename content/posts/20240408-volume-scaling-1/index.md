...
[storage with `fio`](https://cloudnative-pg.io/docs/current/benchmarking/#fio)  and
the [database using `pgbench`](https://cloudnative-pg.io/docs/current/benchmarking/#pgbench)
...
[“Pod Controller” page from the CloudNativePG documentation](https://cloudnative-pg.io/docs/current/controller/).
...
[rolling update](https://cloudnative-pg.io/docs/current/rolling_update/#automated-updates-unsupervised)

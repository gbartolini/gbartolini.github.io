...
title: "CNPG Recipe 27 - Running OpenBao on Kubernetes with a CloudNativePG
  PostgreSQL backend"
date: 2026-08-17T18:48:42+10:00
...
plus `cnpg-playground`'s own
[prerequisites](https://github.com/cloudnative-pg/cnpg-playground#prerequisites):
the `cnpg` plugin for `kubectl`, and, since `./demo/setup.sh` also installs
cert-manager, `cmctl`.

...
[directly understand and manage a PostgreSQL cluster](https://cloudnative-pg.io/docs/current/controller/),
...
- ["Custom Pod Controller" page from CloudNativePG documentation](https://cloudnative-pg.io/docs/current/controller/) (May 2022)
